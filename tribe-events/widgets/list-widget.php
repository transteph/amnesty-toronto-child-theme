		...
		foreach ( $posts as $post ) :
			...
			<li class="tribe-events-list-widget-events <?php tribe_events_event_classes() ?>">
				...
				<div class="event-venue">
					<strong><?php  echo the_event_venue (); ?></strong>
					<br>
					<?php echo tribe_get_address(); ?>
					<br>
					<?php echo tribe_get_city(); ?>, <?php echo tribe_get_stateprovince(); ?>
					<br>
				</div>
				<?php do_action( 'tribe_events_list_widget_after_the_meta' ) ?>
				
				<div class="event-details-link square-button"><a href="<?php echo esc_url( tribe_get_event_link() ); ?>">DETAILS</a></div>
			</li>
		<?php
		endforeach;
		?>
